...
class TestLatest(unittest.TestCase):
    ...
    def test_version_difference(self):
        result = latest(['3.0.624-zero-release-tests-v1', '3.0.624-zero-release-tests-v9'])
        self.assertEqual( result, '3.0.624-zero-release-tests-v9')

    def test_version_difference(self):
        result = latest(['3.0.624-zero-release-tests-v10', '3.0.624-zero-release-tests-v9'])
        self.assertEqual( result, '3.0.624-zero-release-tests-v10')

    def test_all_difference(self):
        result = latest(['3.0.9-z', '3.1.624-z-v22', '14.0.624-z-v88', '12.17.624-z-v8', '14.0.628-z-v1', '1.2.3-z-v4'])
